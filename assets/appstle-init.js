(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0576/0965/0366/t/4/assets/appstle-subscription.js?v=1660304930");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": ".btn.btn--full.product-form__cart-submit",
        "moneyFormat": "{% raw %}${{amount}}{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "greenwoodhvacpro.myshopify.com",
        "deliveryText": "delivery",
        "purchaseOptionsText": "Purchase Options",
        "manageSubscriptionButtonText": "Manage Subscription",
        "subscriptionOptionText": "Monthly Plan Subscription",
        "sellingPlanSelectTitle": "MONTHLY PAYMENT",
